...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {Korea Advanced Institute of Science and Technology (KAIST) (Advisor: Prof. Hyun Myung)}{Daejeon, Korea}
      \resumeItemListStart
        \resumeItem{Improved localization robustness in dynamic scenes by developing real-time LiDAR-inertial and visual SLAM pipelines.}
